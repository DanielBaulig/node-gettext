...
var parse_locale_data = function(locale_data, l) {
    ...
    for (domain in locale_data) {
        ...
        if (! isValidObject(this.data[l][domain]) ) {
            this.data[l][domain] = { };
        }
        if (! isValidObject(this.data[l][domain].head) ) {
            this.data[l][domain].head = { };
        }
        if (! isValidObject(this.data[l][domain].msgs) ) {
            this.data[l][domain].msgs = { };
        }
        ...
        for (var key in data) {
            if (key === "") {
                ...
                for (var head in header) {
                    ...
                    this.data[l][domain].head[h] = header[head];
                }
            } else {
                this.data[l][domain].msgs[key] = data[key];
            }
        }
    }
    ...
    for (domain in this.data[l]) {
        if (isValidObject(this.data[l][domain].head['plural-forms']) &&
...
Gettext.prototype = {
    ...
    dcnpgettext: function (d, msgctxt, msgid, msgid_plural, n, category) {
        ...
        var msg_ctxt_id = isValidObject(msgctxt) ? msgctxt+this.context_glue+msgid : msgid;
        ...
        if (typeof(this.data[lang]) != 'undefined' &&
            isValidObject(this.data[lang][domainname])) {
